const ease = {
  ...
  exponentialInOut: (t) => (t === 0.0 || t === 1.0 ? t : t < 0.5 ? +0.5 * Math.pow(2.0, (20.0 * t) - 10.0) : -0.5 * Math.pow(2.0, 10.0 - (t * 20.0)) + 1.0),
  sineOut: (t) => { const HALF_PI = 1.5707963267948966; return Math.sin(t * HALF_PI) },
  circularInOut: (t) => (t < 0.5 ? 0.5 * (1.0 - Math.sqrt(1.0 - 4.0 * t * t)) : 0.5 * (Math.sqrt((3.0 - 2.0 * t) * (2.0 * t - 1.0)) + 1.0)),
  cubicIn: (t) => (t * t * t),
